...
class CitiesTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let arrayIndex = indexPath.row //indexPath.row is to indicate the row that is coming into the index that is coming into view.
        let myCityInstance = self.myCities[arrayIndex]
